...
import authService from '../services/authService'; // Importado authService para logout
...
    
    // [NUEVO ESTADO] Para manejar la edición de nombre de carpeta
...
    };
    ...
    // Handler para iniciar la edición en el sidebar
    const handleStartFolderRename = (folder) => {
        setEditingFolder(folder);
        setNewFolderRename(folder.nombre);
    };

    // Handler para renombrar la carpeta
    const handleUpdateFolder = async (e) => {
        e.preventDefault();
        if (!newFolderRename.trim() || newFolderRename.trim() === editingFolder.nombre) {
...
    // --- RENDERIZADO ---
    return (
        <div className="dashboard-layout"> {/* Cuidado: className cambiado de container a layout */}
            {/* TOAST MESSAGE */}
            {message && (
