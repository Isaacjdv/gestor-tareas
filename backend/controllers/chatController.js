...
exports.handleChatMessage = async (req, res) => {
    ...
    // [¡CORRECCIÓN!] Cambiamos .content por .text para que coincida con el frontend
    ...
    try {
        ...
        switch (interpretation.intent) {
            ...
            case 'generate_pdf': {
                ...
                // [MEJORA] Añadimos un mensaje de "generando"
                res.json({ reply: `Entendido. Estoy generando tu PDF sobre "${query}". Esto puede tomar un momento...` });
                
                // (Iniciamos la generación de forma asíncrona)
                try {
                    ...
                    // (Aquí podríamos enviar un mensaje de WhatsApp si quisiéramos)
                    // Por ahora, el usuario verá la URL en el chat del dashboard en el futuro.
                } catch (pdfError) {
                    console.error("Error generando PDF asíncrono:", pdfError);
                }
                return; // Importante: Salir ya que la respuesta inicial ya fue enviada.
            }
