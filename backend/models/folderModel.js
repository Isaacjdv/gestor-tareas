...
// Añadida la función findById que faltaba
...
    // ON DELETE CASCADE en la BD se encarga de las subcarpetas y archivos
    const { rowCount } = await db.query('DELETE FROM carpetas WHERE id = $1', [id]);
    return rowCount > 0;
};

// Encontrar una carpeta por su nombre y el ID del usuario (insensible a mayúsculas: ILIKE)
